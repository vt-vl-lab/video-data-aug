...
def main():
    ...
    dataset_labeled = build_dataset(cfg.data.train_labeled)
    dataset_unlabeled = build_dataset(cfg.data.train_unlabeled)

    if len(cfg.workflow) == 2:
        raise NotImplementedError('Please use --validate instead!')
