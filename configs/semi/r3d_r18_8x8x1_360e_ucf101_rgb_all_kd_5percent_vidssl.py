...
ann_file_train_labeled = f'data/ucf101/videossl_splits/ucf101_train_5_percent_labeled_split_{split}_rawframes.txt'
...
log_level = 'INFO'
work_dir = './work_dirs/r3d_r18_8x8x1_360e_ucf101_rgb_all_kd_5percent_vidssl/'
load_from = None
resume_from = None
workflow = [('train', 1)]
