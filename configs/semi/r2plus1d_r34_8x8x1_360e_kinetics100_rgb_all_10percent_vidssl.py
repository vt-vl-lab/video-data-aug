...
ann_file_train_labeled = 'data/kinetics400/videossl_splits/kinetics100_train_10_percent_labeled_rawframes.txt'
...
log_level = 'INFO'
work_dir = './work_dirs/r2plus1d_r34_8x8x1_360e_kinetics100_rgb_all_10percent_vidssl/'
load_from = None
resume_from = None
workflow = [('train', 1)]
