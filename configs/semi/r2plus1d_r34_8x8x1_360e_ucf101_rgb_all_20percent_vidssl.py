...
ann_file_train_labeled = f'data/ucf101/videossl_splits/ucf101_train_20_percent_labeled_split_{split}_rawframes.txt'
...
log_level = 'INFO'
work_dir = './work_dirs/r2plus1d_r34_8x8x1_360e_ucf101_rgb_all_20percent_vidssl/'
load_from = None
resume_from = None
workflow = [('train', 1)]
