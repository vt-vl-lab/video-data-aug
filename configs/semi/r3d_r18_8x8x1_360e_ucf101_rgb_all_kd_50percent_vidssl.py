...
#train_cfg = None
train_cfg = dict(actor_cutmix=True, knowledge_distill=True)
...
ann_file_train_labeled = f'data/ucf101/videossl_splits/ucf101_train_50_percent_labeled_split_{split}_rawframes.txt'
...
# ImageNet classification file
cls_file = f'data/ucf101/resnet18_prtrnd_preds.npy'
...
data = dict(
    ...
    train_unlabeled=dict(
        ...
        cls_file=cls_file,    # Custom imports
        data_prefix=data_root,
...
log_level = 'INFO'
work_dir = './work_dirs/r3d_r18_8x8x1_360e_ucf101_rgb_all_kd_50percent_vidssl/'
load_from = None
resume_from = None
workflow = [('train', 1)]
