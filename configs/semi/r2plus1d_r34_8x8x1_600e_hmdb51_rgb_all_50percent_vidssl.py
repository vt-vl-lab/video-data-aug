...
split = 1
ann_file_train_labeled = 'data/hmdb51/videossl_splits/hmdb51_train_50_percent_labeled_split_1_rawframes.txt'
...
log_level = 'INFO'
work_dir = './work_dirs/r2plus1d_r34_8x8x1_600e_hmdb51_rgb_all_50percent_vidssl/'
load_from = None
resume_from = None
workflow = [('train', 1)]
