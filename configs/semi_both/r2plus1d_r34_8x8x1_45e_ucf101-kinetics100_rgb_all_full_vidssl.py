...
data_root_labeled = 'data/ucf101/rawframes/'
data_root_unlabeled = 'data/kinetics400/rawframes_train'
data_root_val = 'data/ucf101/rawframes/'
split = 1  # official train/test splits. valid numbers: 1, 2, 3
ann_file_train_labeled = f'data/ucf101/ucf101_train_split_{split}_rawframes.txt'
...
det_file_labeled = f'data/ucf101/detections.npy'
...
data = dict(
    ...
    train_unlabeled=dict(
        ...
        det_file=det_file_unlabeled,    # Custom imports
...
log_level = 'INFO'
work_dir = './work_dirs/r2plus1d_r34_8x8x1_45e_ucf101-kinetics100_rgb_all_full_vidssl_both_aug/'
load_from = None
resume_from = None
workflow = [('train', 1)]
