...
# dataset settings
dataset_type_train = 'UnlabeledRawframeDataset'
dataset_type_test = 'RawframeDataset'
data_root = 'data/kinetics400/rawframes_train'
data_root_val = 'data/kinetics400/rawframes_val'

ann_file_train = 'data/kinetics400/videossl_splits/kinetics100_train_100_percent_labeled_rawframes.txt'
ann_file_val = 'data/kinetics400/videossl_splits/kinetics100_val_100_percent_labeled_rawframes.txt'
ann_file_test = 'data/kinetics400/videossl_splits/kinetics100_val_100_percent_labeled_rawframes.txt'
# Human box detections
det_file = f'data/kinetics400/detections.npy'
...
data = dict(
    videos_per_gpu=16,    # NOTE: Need to reduce batch size. 16 -> 5
...
evaluation = dict(
    interval=10, metrics=['top_k_accuracy', 'mean_class_accuracy'], topk=(1, 5))    # Default: 5
log_config = dict(
...
log_level = 'INFO'
work_dir = './work_dirs/r2plus1d_r34_8x8x1_180e_kinetics100_rgb_all_100percent_vidssl_supervised_aug/'
load_from = None
resume_from = None
workflow = [('train', 1)]
