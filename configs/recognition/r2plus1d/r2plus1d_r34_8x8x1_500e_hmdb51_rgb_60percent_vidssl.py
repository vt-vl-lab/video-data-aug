...
ann_file_train = f'data/hmdb51/videossl_splits/hmdb51_train_60_percent_labeled_split_{split}_rawframes.txt'
...
log_level = 'INFO'
work_dir = './work_dirs/r2plus1d_r34_8x8x1_500e_hmdb51_rgb_60percent_vidssl/'
load_from = None
resume_from = None
workflow = [('train', 1)]
